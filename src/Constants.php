...
class Constants
{
  const REQUEST_ENDPOINT      = "https://api-development.recast.ai/v2/request";
  const CONVERSE_ENDPOINT     = "https://api-development.recast.ai/v2/converse";
  const CONVERSATION_ENDPOINT = "https://api-development.recast.ai/connect/v1/messages";
  const MESSAGE_ENDPOINT      = "https://api-development.recast.ai/connect/v1/conversations/:conversation_id/messages";
